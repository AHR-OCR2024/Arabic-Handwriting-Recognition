...
image_directory = r"C:\Users\USER\Documents\work\Arabic-Handwriting-Recognition\PDF\imgoutput"

# endpoint api
api_url = "https://7bd2-116-90-183-161.ngrok-free.app/upload-image"

# hasil disimpan sebagai file json
output_file = r"C:\Users\USER\Documents\work\Arabic-Handwriting-Recognition\PDF\result.json"
...
def process_image(image_path):
    try:
        ...
        data = {
            'model': 'model1',
            'geometricUnwrapping': 'false',
            'illuminationRectifying': 'false'
        }
...
def main():
    ...
    if os.path.exists(output_file):
        try:
            ...
            print(f"gagal membaca file hasil yang ada. mulai dari kosong.")
